    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="../../pic/contacct.jpg"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Thông báo<!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="../../pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
  ...
  <TR>
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
        <tr>
          <td width="844" height="94">&nbsp;</td>
          </tr>
        <tr>
          <td height="77" align="center" valign="middle"><div align="center" style="font-weight: bold; color: #FF0000">
<?php
		  	$id=$_REQUEST['id'] ;
			switch ($id)
			{
				case 1: echo("Bạn đã cập nhật thông tin bật/tắt menu dọc!");
						break;
			}
			?>		  </div></td>
