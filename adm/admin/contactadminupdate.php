...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
  ...
  <TR>
    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="../../pic/contacct.jpg"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Thông tin liên hệ chi tiết <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="../../pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
  ...
  <TR>
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
      <?php
	  		include("../../dbconnect.php");
			//Cap nhat thong bao duoc chon thanh da xem
			$id=$_REQUEST['id'];
			if (trim($id)!="")
			{
				$str1="update contact set Viewed=1 where ContactID=". $id;
				$result=mysql_query($str1) or die(mysql_error());
			}
			//Hien thi thong tin chi tiet
			$str1="select * from contact where ContactID=".$id;
			$result=mysql_query($str1) or die(mysql_error());
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td valign="top" class="window_text_left"><?php echo($row['Name']);?></td>
          </tr>
        <tr>
          <td height="25">&nbsp;</td>
          <td valign="top">Địa chỉ: </td>
          <td valign="top" class="window_text_left"><?php echo($row['Address']);?></td>
          </tr>
        <tr>
          <td height="25">&nbsp;</td>
          <td valign="top">Điện thoại: </td>
          <td valign="top" class="window_text_left"><?php echo($row['Phone']);?></td>
          </tr>
        <tr>
          <td height="25">&nbsp;</td>
          <td valign="top">Email:</td>
          <td valign="top" class="window_text_left"><?php echo("<a href='mailto:".$row['Email']."'>".$row['Email'])."</a>";?></td>
          </tr>
        <tr>
          <td height="25">&nbsp;</td>
          <td valign="top">Tiêu đề: </td>
          <td valign="top" class="window_text_left"><?php echo($row['Title']);?></td>
          </tr>
        <tr>
          <td height="25">&nbsp;</td>
          <td valign="top">Nội dung: </td>
          <td rowspan="2" valign="top" class="window_text"><?php echo($row['Content']); mysql_free_result($result);?></td>
          </tr>
        <tr>
          <td height="156">&nbsp;</td>
          <td>&nbsp;</td>
