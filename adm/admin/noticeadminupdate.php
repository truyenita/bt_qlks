  ...
  <TR>
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
		<?php
			...
			if ($mode==2)
			{
				$str1="select * from notice where NoticeID=".$id;
		...
		?>      
	<form name=form action=noticeadmin.php?mode=2&id=<?php if ($mode==2) echo($row['NoticeID']);?> method=post>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="25"></td>
          <td valign="top">Mã thông báo </td>
          <td colspan="2" valign="top"><input name="noticeid" type="text" disabled="disabled" id="noticeid" value="<?php if ($mode==2) echo($row['NoticeID']);?>"></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td height="25"></td>
          <td valign="top">Nội dung thông báo </td>
          <td colspan="3" rowspan="2" valign="top"><label>
            <textarea name="noticecontent" cols="80" rows="8" id="noticecontent"><?php if ($mode==2) echo($row['NoticeContent']);?></textarea>
          </label></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="24"></td>
          <td valign="top">Hiển thị ở trang chủ: </td>
          <td valign="top"><label>
            <input name="homepage" type="checkbox" value="1"    
			<?php 
				if ($mode==2)
				{	
					if ($row['ShowInHomePage']==1)
					{
						echo(" checked");
