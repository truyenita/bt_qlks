...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
  ...
  <TR>
    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="../../pic/contacct.jpg" width="52" height="29"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Thông tin liên hệ <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="../../pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
  ...
  <TR>
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
      ...
      <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#0066FF">
        <!--DWLayoutTable-->
        <tr>
          <td width="74" height="25" valign="top" class="admintitlecenter">Mã LH </td>
          <td width="221" valign="top" class="admintitlecenter">Họ tên </td>
          <td width="382" valign="top" class="admintitlecenter">Tiêu đề </td>
          <td width="157" valign="top" class="admintitlecenter">Cập nhật</td>
        </tr>
		<?php
			include("../../dbconnect.php");
			$mode=$_REQUEST['mode'] ;
			...
			if ($mode=='1')
			{
				$str1="delete from contact where ContactID=". $id;
			...
			{
				echo("<tr><td height='25' valign='middle'><center>".$row['ContactID']."</center></td><td valign='top'>".$row['Name']."</td><td valign='middle' align='center'><center>".$row['Title']."</center></td><td valign='middle' align='center'><center><a href='contactadminupdate.php?mode=2&id=".$row['ContactID']."'>Chi tiết</a>&nbsp;&nbsp;&nbsp;<a href='contactadmin.php?mode=1&id=".$row['ContactID']."'>Xóa</a><center></td></tr>");
			}
