              ...
              <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                ...
                <TBODY>
                  ...
                  width=29></div></TD>
					  ...
					  <a href="../index.php" class="nav">&nbsp;&nbsp;Trang chủ </a>
    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="pic/notice.jpg" width="52" height="29"><!-- InstanceEndEditable --></td>
            <td width="243" valign="middle" class="window_text_left_bold"><!-- InstanceBeginEditable name="EditRegion2" -->Thông báo <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="../pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
        <tr>
          <td width="844" height="249" valign="top" class="admintitlecenter">
		    <?php
		  	$id=$_REQUEST['id'] ;
			if ($id==1)
				echo("Cảm ơn bạn đã gửi thông tin cho chúng tôi! <br>Chúng tôi sẽ trả lời cho bạn trong thời gian sớm nhất!");
		  ?>		  </td>
        </tr>
        <tr>
          <td height="77">&nbsp;</td>
