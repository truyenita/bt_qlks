    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Cập nhật loại vb<!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
        ...
        <tr>
          ...
          <td valign="top"><TABLE class="deco" height=29 cellSpacing=0 cellPadding=0 
            ...
            <TBODY>
              ...
              <?php
					...
					if ($mode=='1')
					{
						$str1="delete from lawdoc_loai where id=". $id;
					...
					if ($mode=='2')
					{
						...
						$typename=mysql_real_escape_string($_REQUEST['ten']);

						$str1="update lawdoc_loai set ten='".$typename."' where id=". $typeid;
						//echo($str1);
						$result=mysql_query($str1) or die(mysql_error());
					}						
					...
					$str1="insert into lawdoc_loai(ten) values('".$typename
					."')";
						//echo($str1);
						$result=mysql_query($str1) or die(mysql_error());
					}					
					...
					//Hien thi danh sach 
					$str1="select * from lawdoc_loai order by id desc";
					...
					while ($row=mysql_fetch_array($result))
					{
						...
						echo("<TD vAlign=center height=24>&nbsp;&nbsp;".$row['ten']."</TD>");
						echo("<TD vAlign=center align=middle><center><a href='lawdocadmin_loaivb.php?mode=20&id=".$row['id']."'>Sửa</a>");
						echo("&nbsp;&nbsp;&nbsp;<a href='lawdocadmin_loaivb.php?mode=1&id=".$row['id']."'>Xóa</a></center></TD></TR>");
					}
					mysql_free_result($result);
				?>
              </TBODY>
          ...
          <td rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
           ...
           <?php
		   		///////// Cap nhat
				if ($mode==20)
					$action="lawdocadmin_loaivb.php?mode=2&id=".$id;
				else
					if ($mode==30)
						$action="lawdocadmin_loaivb.php?mode=3";
					else	
						$action="lawdocadmin_loaivb.php";
		   ?>
		   <form name="form" action="<?php echo($action);?>" method="post">
		    <tr>
              ...
              <td width="261" valign="middle"><label>
                <input name="ten" type="text" id="ten" size="30" maxlength="200" 
				value="<?php 
				$id=mysql_real_escape_string($_REQUEST['id']);
				if ($id<1) $id=-2;
				echo(getValue('ten','lawdoc_loai','id',$id));?>">
              </label></td>
            </tr>
            <tr>
              <td height="29">&nbsp;</td>
              <td valign="middle">
				...
				onclick="window.open('lawdocadmin_loaivb.php?mode=30','_self')"></td>
              </tr>
			 </form> 
