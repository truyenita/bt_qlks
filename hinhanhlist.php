...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
  ...
  <TR>
    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" -->aa<!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Danh sách<!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
        <tr>
         <td height="458" valign="top"><p><a href="hinhanhadd.php">+ Thêm hình mới</a></p>
           <table width="100%" class="deco" height=29 cellSpacing=0 cellPadding=0 
                  align=center border=1 bordercolor="#a6caf0">
        <tr>
          <td width="4%" align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">STT</td>
          <td width="29%" align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Hình</td>
          <td width="26%" align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Ghi chú</td>
		  <td width="14%" align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Album</td>
          <td width="5%" align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Trạng thái</td>
          <td width="20%" align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Chức năng</td>
        </tr>
        <?php 
		$sql_select_ha = "select * from album2 order by id desc";
		$stt=1;
		$c=0;
		
		$result_select_ha = mysql_query($sql_select_ha) or die(mysql_error());
		RecordsIgnore($row_select_ha,$result_select_ha);
		while($row_select_ha = mysql_fetch_array($result_select_ha))
		{
		$c++;
		?>
        <tr>
          ...
          <td><img src="<?php echo($row_select_ha["duongdananh"]); ?>" border="0" height="45" width="60" /></td>
          <td><?php echo($row_select_ha["ghichu"]); ?></td>
          <td><?php $result_select= mysql_query("select * from album1 where `id`='".$row_select_ha["idalbum1"]."'") or die(mysql_error());
        $row_select=mysql_fetch_array($result_select);
        echo($row_select["tenalbum"]); 
        ?></td>
          <td><?php echo($row_select_ha["trangthai"]=="1"?"bật":"tắt"); ?></td>
          <td><a href="hinhanhedit.php?editid=<?php echo($row_select_ha["id"]); ?>"><img src="image/edit.gif" alt="Sửa" width="30" height="30" border="0" /></a> <a href="hinhanh.php?delid=<?php echo($row_select_ha["id"]); ?>"><img src="image/delete.gif" alt="Xóa" width="30" height="30" border="0" /></a></td>
        </tr>
        <?php 
		if ($c==getPara('recordsperpage','value1')) break;
           ...
           <p>
		   <?php
		  	$selectcountsql="select count(*) as sumrecords from album2 order by id desc";
			ShowPageBreak($selectcountsql,"hinhanhlist.php");
		  ?>
		  </p>
		  </td>
        </tr>
