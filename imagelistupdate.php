    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="pic/notice.jpg" width="52" height="29"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Cập nhật hình ảnh hoạt động <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
  ...
  <TR>
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
		<?php
			...
			$str1="select * from imagelist where imageid='".$id."'";
			$result=mysql_query($str1) or die(mysql_error());
			$row = mysql_fetch_array($result);
			//mysql_free_result($result);
		?>      
	<form name=form action=imagelistadmin.php?mode=2&id=<?php echo($row['imageid']);?> method=post>
	 ...
	 <SCRIPT language=JavaScript type=text/JavaScript>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td valign="top"><input name="title" type="text" id="title" value="<?php echo($row['title']);?>" size="70" maxlength="300"></td>
          </tr>		
	...
	<script type="text/javascript">
		...
		function SetFileField( fileUrl )
		{
          ...
          <td valign="top"><input name="file" type="text" id="file" value="<?php echo($row['file']);?>" size="50" maxlength="200">
		  &nbsp;
