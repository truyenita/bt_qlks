    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Thêm Video<!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
        <tr>
          <td height="458" valign="top"><br />
    <form id="form1" name="form1" method="post" action="video.php" enctype="multipart/form-data">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
          <td>Tên Video:</td>
          <td><label>
            <input name="ghi_chu" type="text" id="ghi_chu" size="50" />
          </label></td>
        </tr>
		<tr>
          <td valign="top">Đường link : </td>
          <td valign="top"><input name="link" type="text" id="link" size="50" maxlength="200">
            <input type="button" name="Submit3" value="Chọn file" onClick="BrowseServerVideo();">
		  </td>
          </tr>	
		<tr>
          <td valign="top">Ảnh minh họa: </td>
          <td valign="top"><input name="imagelink" type="text" id="imagelink" size="50" maxlength="200">
        ...
        <tr>
          <td>Trạng thái:</td>
          <td><label>
            <input type="checkbox" name="trang_thai" id="trang_thai"/>
          </label></td>
        </tr>
        <tr>
          <td>Video nổi bật:</td>
          <td><label>
            <input type="checkbox" name="hot" id="hot" checked="checked"/>
          </label></td>
        </tr>
        <tr>
	...
	<script type="text/javascript">
		...
		function SetFileFieldVideo( fileUrlVideo )
		{
          ...
          <td><label>
            <input type="submit" name="addvideo" id="addvideo" value="Lưu" />
