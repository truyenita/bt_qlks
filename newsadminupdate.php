...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
 ...
 <SCRIPT language=JavaScript type=text/JavaScript>
		...
		<?php
			...
			$str1="select * from news where newsid=".$newsid;
			$result=mysql_query($str1) or die(mysql_error());
			$row=mysql_fetch_array($result);

		?>     
	<form name=form action='newsadmin.php?mode=2&id=<?php echo($newsid);?>' method=post>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td valign="top"><select name="newsgroup" id="newsgroup">
					<?php
			//include("dbconnect.php");
			$str0="select * from menu where menutype=1";
			$result0=mysql_query($str0) or die(mysql_error());
			while ($row0=mysql_fetch_array($result0))
			{
				echo("<option ");
				if ($row['newsgroup']==$row0['menuid']) echo("selected='selected'");
        ...
        <tr>
          ...
          <td valign="top"><input name="title" type="text" id="title" value='<?php echo($row['title']);?>' size="90" maxlength="300"></td>
          </tr>

        <tr>
          <td height="25"></td>
          <td valign="top">Ngày cập nhật </td>
          <td valign="top"><input name="date" type="text" id="date" size="15" maxlength="15"  value='<?php echo($row['date']);?>' >
            <a href="javascript:void(displayDatePicker('date', false, 'ymd', '-'))"><img src="image/date.jpg" width="20" height="16" border="0"></a>
	...
	<script type="text/javascript">
        ...
        <tr>
          ...
          <td valign="top"><input name="image" type="text" id="image" size="50" maxlength="100"  value='<?php echo($row['image']);?>' >
		  &nbsp;
        ...
        <tr>
          ...
          <td valign="top"><select name="imagepos" id="imagepos">
            <option value="1" <?php if ($row['imagepos']==1) echo("selected='selected'");?>>Bên trái</option>
            <option value="2" <?php if ($row['imagepos']==2) echo("selected='selected'");?>>Bên phải</option>
            <option value="3" <?php if ($row['imagepos']==3) echo("selected='selected'");?>>Ở giữa</option>
          </select>
          </td>
        </tr>
        <tr>
          ...
          <td valign="top"><input name="imagedes" type="text" id="imagedes" size="90" maxlength="300" value='<?php echo($row['imagedes']);?>'></td>
        </tr>				
        <tr>
          <td height="25"></td>
          <td valign="top">Tác giả </td>
          <td valign="top"><input name="author" type="text" id="author" size="50" maxlength="200"  value='<?php echo($row['author']);?>' ></td>
        </tr>
        <tr>
          <td height="25"></td>
          <td valign="top">Tin nổi bật </td>
          <td valign="middle">
            <input name="topnews" type="checkbox" id="topnews"<?php echo($row["topnews"]=="1"?"checked='checked'":""); ?>>
            </td>
        </tr>
        <tr>
          <td height="25"></td>
          <td valign="top">Trích yếu </td>
          <td rowspan="2" valign="top"><textarea name="abstract" cols="70" rows="4" id="abstract" class="newscontent"><?php echo($row['abstract']);?></textarea></td>
        </tr>
        <tr>
          <td height="40"></td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td height="316"></td>
          <td colspan="2" valign="top"><textarea cols="80" id="content" name="content" rows="10"> <?php echo($row['content']);mysql_free_result($result);?></textarea> 
			<script type="text/javascript"> 
			//<![CDATA[
