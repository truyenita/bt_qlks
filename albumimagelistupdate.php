...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" -->aa<!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Album Edit<!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
 ...
 <?php
			...
			$str1="select * from album1 where id='".$id."'";
			$result=mysql_query($str1) or die(mysql_error());
			$row = mysql_fetch_array($result);
			//mysql_free_result($result);
		?>      
	<form name=form action=albumimagelist.php?mode=2&id=<?php echo($row['id']);?> method=post>
	
	 <SCRIPT language=JavaScript type=text/JavaScript>
					<!--
 					function Check()
					{
						if(document.form.tenalbum.value=="")
						{
							alert("Bạn chưa nhập tên album!");
							document.form.tenalbum.focus();
							return false;
						}
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="25"></td>
          <td valign="top">Chủ đề album </td>
          <td valign="top"><input name="tenalbum" type="text" id="tenalbum" value="<?php echo($row['tenalbum']);?>" size="70" maxlength="300"></td>
          </tr>		
<tr>
          <td height="25"></td>
          <td valign="top">Hình minh họa </td>
          <td width="80%">
            <input name="link" type="text" id="link" value="<?php echo($row['link']);?>" size="50" maxlength="200">
            <input name="submit" type="button" value="Chọn Image" onClick="BrowseServer();" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo($row["link"]); ?>" border="0" height="45" width="60" />
          </td>
          </tr>	
			<tr>
			<td height="25"></td>
          <td>Trạng thái:</td>
          <td><label>
            <input type="checkbox" name="trang_thai" id="trang_thai" <?php echo($row["trang_thai"]=="1"?"checked='checked'":""); ?>/>
          </label></td>
        </tr>
