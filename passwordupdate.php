...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="pic/notice.jpg" width="52" height="29"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Đổi mật khẩu <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
 ...
 <SCRIPT language=JavaScript type=text/JavaScript>
 					...
 					function Check()
					{
						...
						if(document.form.newpass1.value=="")
						{
							alert("Bạn chưa nhập mật khẩu mới!");
							document.form.newpass1.focus();
							return false;
						}
						if(document.form.newpass2.value=="")
						{
							alert("Bạn chưa nhập lại mật khẩu mới");
							document.form.newpass2.focus();
							return false;
						}
					}
	...
	<form name=form action='updatedb.php?action=3' method=post>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td colspan="2" valign="top"><input name="userid" disabled="disabled" type="text" id="userid" size="20" maxlength="20" value="<?php echo($_SESSION['user']);?>"></td>
          </tr>		
        <tr>
          <td height="25"></td>
          <td valign="top">Mật khẩu cũ </td>
          <td colspan="2" valign="top"><input name="oldpass" type="password" id="oldpass" size="20" maxlength="20"></td>
          </tr>

        <tr>
          <td height="25"></td>
          <td valign="top">Mật khẩu mới </td>
          <td colspan="2" valign="top"><input name="newpass1" type="password" id="newpass1" size="20" maxlength="20"></td>
          </tr>
        <tr>
          <td height="25"></td>
          <td valign="top">Nhập lại mật khẩu </td>
          <td colspan="2" valign="top"><input name="newpass2" type="password" id="newpass2" size="20" maxlength="20"></td>
          </tr>		  
        <tr>
          <td height="25"></td>
          <td></td>
