    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="pic/notice.jpg" width="52" height="29"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Xem chi tiết tin tức <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
		  ...
		  <?php
				...
				echo("<div  class='newstitleNOLINK");echo(template());echo("'>".$row['title']."</div>"); 
				//echo("<br>");
				//echo("<br>");
        ...
        <tr>
		  ...
		  <?php 
		  	...
		  	{
		  ?>
		  <form name="form" action="updatedb.php?action=13&id=<?php echo($row['newsid']);?>" method="post">
		  <?php 
		  if (newsApproval($_SESSION['user'])==1)
		  {
		  ?>
		  <input type="submit" name="Submit" value="Duyệt tin">
		  <?php
		  }
		  ?>
		  <input type="button" name="button" value="Quay lại trang trước" onClick="javascript:history.back()">
		  </form>
		  <?php
		  	}
			else
			{
			?>
		  <form name="form" action="updatedb.php?action=14&id=<?php echo($row['newsid']);?>" method="post">
		  <?php 
		  if (newsApproval($_SESSION['user'])==1)
		  {
		  ?>
		  <input type="submit" name="Submit" value="Ẩn tin này">
		  <?php
		  }
		  ?>
		  <input type="button" name="button" value="Quay lại trang trước" onClick="javascript:history.back()">
