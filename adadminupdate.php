  ...
  <TR>
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
		<?php
			...
			$str1="select * from ad where adid='".$id."'";
			$result=mysql_query($str1) or die(mysql_error());
			$row = mysql_fetch_array($result);
			//mysql_free_result($result);
		?>      
	<form name=form action=adadmin.php?mode=2&id=<?php echo($row['adid']);?> method=post>
	
	 <SCRIPT language=JavaScript type=text/JavaScript>
					<!--
 					function Check()
					{
						if(document.form.adname.value=="")
						{
							alert("Bạn chưa nhập tên đơn vị!");
							document.form.adname.focus();
							return false;
						}
						if(document.form.adurl.value=="")
						{
							alert("Bạn chưa nhập URL!");
							document.form.adurl.focus();
							return false;
						}
						if(document.form.adimage.value=="")
						{
							alert("Bạn chưa nhập tên file ảnh");
							document.form.adimage.focus();
							return false;
						}
						if (isNaN(document.form.adorder.value))
						{
							alert("Bạn phải nhập vị trí của quảng cáo là chữ số!");
							document.form.adorder.focus();
							return false;
						}
					}
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="25"></td>
          <td valign="top">Tên đơn vị </td>
          <td valign="top"><input name="adname" type="text" id="adname" value="<?php echo($row['adname']);?>" size="70" maxlength="300"></td>
          </tr>		
        ...
        <tr>
          ...
          <td valign="top"><input name="adurl" type="text" id="adurl" value="<?php echo($row['adurl']);?>" size="50" maxlength="200">
		  &nbsp;           <input type="button" name="Submit2" value="Chọn file" onClick="BrowseServer1();">
		  </td>
          </tr>
	<script type="text/javascript" src="ckfinder/ckfinder.js"></script>
	<script type="text/javascript">
		...
		{
			document.getElementById( 'adimage' ).value = fileUrl ;
		}
		...
		{
			document.getElementById( 'adurl' ).value = fileUrl ;
		}

	</script>	
		         <tr>
          <td height="25"></td>
          <td valign="top">Tên file ảnh </td>
          <td valign="top"><input name="adimage" type="text" id="adimage" value="<?php echo($row['adimage']);?>" size="50" maxlength="200">
		  &nbsp;
            <input type="button" name="Submit2" value="Chọn file" onClick="BrowseServer();">
		          ...
		          <tr>
          <td height="25"></td>
          <td valign="top">Thứ tự hiển thị </td>
          <td valign="top"><input name="adorder" type="text" id="adorder" value="<?php echo($row['adorder']);?>" size="5" maxlength="5"></td>
          </tr>	
		          <tr>
          <td height="25"></td>
          <td valign="top">Vị trí hiển thị </td>
          <td valign="top"><label>
            <select name="adleft" id="adleft">
              <option value="0" <?php if ($row['adleft']==0) echo("selected='selected'");?>>Bên phải</option>
              <option value="1" <?php if ($row['adleft']==1) echo("selected='selected'");?>>Bên trên</option>
            </select>
          </label></td>
		          </tr>	
