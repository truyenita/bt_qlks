...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="pic/notice.jpg" width="52" height="29"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Thêm mới người dùng <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
 ...
 <SCRIPT language=JavaScript type=text/JavaScript>
	...
	<form name='frm1' id='frm1' action='useradmin.php?mode=3' method=post>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td colspan="2" valign="top"><input name="userid" type="text" id="userid" size="20" maxlength="20"></td>
          </tr>		
        <tr>
          <td height="25"></td>
          <td valign="top">Tên người dùng </td>
          <td colspan="2" valign="top"><input name="username" type="text" id="username"  size="50" maxlength="100"></td>
          </tr>
       <tr>
          <td height="25"></td>
          <td valign="top">Chức năng được sử dụng </td>
          <td colspan="2" valign="middle">&nbsp;
            <input name="admin" type="checkbox"  id="admin" value="1" onclick='checkedAll(frm1);' >&nbsp;Quản trị			</td>
        </tr>
        <tr>
          <td height="25"></td>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td colspan="2" valign="middle">&nbsp;
            <input name="lawdoc" type="checkbox" id="lawdoc" value="1">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td colspan="2" valign="middle">&nbsp;
            <input name="faq" type="checkbox" id="faq" value="1">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td colspan="2" valign="middle">&nbsp;
            <input name="document" type="checkbox" id="document" value="1">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td colspan="2" valign="middle">&nbsp;
            <input name="notice" type="checkbox" id="notice" value="1">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td colspan="2" valign="middle">&nbsp;
            <input name="ad" type="checkbox" id="ad" value="1">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td colspan="2" valign="middle">&nbsp;
            <input name="timetable" type="checkbox" id="timetable" value="1">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td colspan="2" valign="middle">&nbsp;
            <input name="imagelist" type="checkbox" id="imagelist" value="1">
          ...
          <td>&nbsp;</td>
          <td colspan="2" valign="middle">&nbsp;
            <input name="timetableapproval" type="checkbox" id="timetableapproval" value="1">
