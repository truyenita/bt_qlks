...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
  ...
  <TR>
	...
	<form name=form action=imagelistadmin.php?mode=3 method=post>
	 ...
	 <SCRIPT language=JavaScript type=text/JavaScript>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td valign="top"><input name="title" type="text" id="title" size="70" maxlength="300"></td>
          </tr>		
	...
	<script type="text/javascript">
		...
		function SetFileField( fileUrl )
		{
          ...
          <td valign="top"><input name="file" type="text" id="file" size="50" maxlength="200">
		  &nbsp;
