    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Cập nhật liên kết website <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td width="590">&nbsp;</td>
          <td width="161" align="right" valign="middle"><div align="right"><img src="pic/add.jpg" align="middle">&nbsp;&nbsp;<a href="weblistaddnew.php" class="nav">Thêm mới</a> </div></td>
          <td width="53">&nbsp;</td>
        </tr>
        <tr>
          <td height="29">&nbsp;</td>
          <td colspan="2" valign="top"><TABLE class="deco" height=29 cellSpacing=0 cellPadding=0 
            ...
            <TBODY>
              <TR>
                <TD width=11 height=27 align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">STT</TD>
                      <TD width=330 height=27 align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Tên liên kết</TD>
                    <TD width=244 align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Liên kết </TD>
              ...
              <?php
					...
					if ($mode=='1')
					{
						$str1="delete from weblist where id=". $id;
					...
					if ($mode=='2')
					{
						...
						$str1="update weblist set link='".$link."', file='".$file."' where id=". $id;
						//echo($str1);
						$result=mysql_query($str1) or die(mysql_error());
					}						
					...
					if ($mode=='3')
					{
						$link=mysql_real_escape_string($_REQUEST['link']);
						$file=mysql_real_escape_string($_REQUEST['file']);
						$str1="insert into weblist(link,file) ";
						$str1=$str1." values ('".$link."','".$file."')";
						//echo($str1);
						$result=mysql_query($str1) or die(mysql_error());
					}					
					...
					$str1="select * from weblist order by id desc";
					...
					while ($row=mysql_fetch_array($result))
					{
						...
						echo("<TD vAlign=left align=middle height=24>".$row['file']."</TD>");
						echo("<TD vAlign=left align=middle>".$row['link']."</TD>");
						echo("<TD vAlign=center align=middle><center><a href='weblistupdate.php?mode=2&id=".$row['id']."'>Sửa</a>");
						echo("&nbsp;&nbsp;&nbsp;<a href='weblistadmin.php?mode=1&id=".$row['id']."'>Xóa</a></center></TD></TR>");
						$tt++;
					}
					mysql_free_result($result);
				?>
