...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
 ...
 <SCRIPT language=JavaScript type=text/JavaScript>
	...
	<form name="form" id="form" action='adadmin.php?mode=3' method=post>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td valign="top"><input name="adname" type="text" id="adname" size="70" maxlength="300"></td>
          </tr>		
        ...
        <tr>
          ...
          <td valign="top"><input name="adurl" type="text" id="adurl" size="50" maxlength="200">
		  &nbsp;<input type="button" name="Submit2" value="Chọn file" onClick="BrowseServer1();"></td>
	...
	<script type="text/javascript">
		...
		function SetFileField1( fileUrl )
		{
          ...
          <td valign="top"><input name="adimage" type="text" id="adimage" size="50" maxlength="200">
		  &nbsp;<input type="button" name="Submit2" value="Chọn file" onClick="BrowseServer();"></td>
          </tr>	
		          <tr>
          <td height="25"></td>
          <td valign="top">Thứ tự hiển thị </td>
          <td valign="top"><input name="adorder" type="text" id="adorder" size="5" maxlength="5"></td>
          </tr>	
		          <tr>
          <td height="25"></td>
          ...
          <td valign="top"><label>
            <select name="adleft" id="adleft">
              ...
              <option value="1" >Bên trên</option>
            </select>
          </label></td>
		          </tr>	
        ...
        <tr>
          ...
          <td align="center" valign="middle"><label>
            <input onClick="return Check();" type="submit" name="Submit" value="Lưu" >
          </label></td>
          </tr>
        <tr>
          <td height="46"></td>
