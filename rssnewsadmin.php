    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="pic/timetable.jpg"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Quản trị tin RSS <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td valign="top"><TABLE class="deco" height=29 cellSpacing=0 cellPadding=0 
            ...
            <TBODY>
              <TR>
                <TD width=236 height=27 align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Tên báo cung cấp RSS </TD>
                    <TD width=109  align=center vAlign=middle background=pic/bgbt.gif class="table_title">Cập nhật</TD>
                  </TR>
              ...
              <?php
					...
					//Xoa rssurl duoc chon
					if ($mode=='1')
					{
						$str1="delete from rssurl where rssurlid=". $id;
						$result=mysql_query($str1) or die(mysql_error());
						//mysql_free_result($result);
					}
					
					//Cap nhat rssurl duoc chon
					if ($mode=='2')
					{
						$rssurlid=mysql_real_escape_string($_REQUEST['id']);
						$rssurlname=mysql_real_escape_string($_REQUEST['rssurlname']);
						$url=mysql_real_escape_string($_REQUEST['url']);

						$str1="update rssurl set rssurlname='".$rssurlname."', url='".$url."' where rssurlid=". $rssurlid;
						//echo($str1);
						$result=mysql_query($str1) or die(mysql_error());
					}						
					...
					if ($mode=='3')
					{
						...
						$str1="insert into rssurl(rssurlname,url) values ('".$rssurlname."','".$url."')";
						//echo($str1);
						$result=mysql_query($str1) or die(mysql_error());
					}					
					
										
					//Hien thi danh sach rssurl
					$str1="select * from rssurl order by rssurlname";
					...
					while ($row=mysql_fetch_array($result))
					{
						...
						echo("<TD vAlign=center height=24>&nbsp;&nbsp;".$row['rssurlname']."</TD>");
						echo("<TD vAlign=center align=middle><center><a href='rssnewsadmin.php?mode=20&id=".$row['rssurlid']."'>Sửa</a>");
						echo("&nbsp;&nbsp;&nbsp;<a href='rssnewsadmin.php?mode=1&id=".$row['rssurlid']."'>Xóa</a></center></TD></TR>");
					}
					mysql_free_result($result);
				?>
              </TBODY>
          ...
          <td rowspan="2" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
           ...
           <?php
		   		///////// Cap nhat
				if ($mode==20)
					$action="rssnewsadmin.php?mode=2&id=".$id;
				else
					if ($mode==30)
						$action="rssnewsadmin.php?mode=3";
					else	
						$action="rssnewsadmin.php";
		   ?>
		   <form name='form' action="<?php echo($action);?>" method="post">
		    <tr>
              <td width="107" height="29" valign="middle"><strong>Tên báo </strong></td>
              <td width="261" valign="middle"><label>
                <input name="rssurlname" type="text" id="rssurlname" size="30" maxlength="200" 
				value="<?php 
				$id=mysql_real_escape_string($_REQUEST['id']);
				if ($id<1) $id=-2;
				echo(getValue('rssurlname','rssurl','rssurlid',$id));?>">
              </label></td>
            </tr>
		    <tr>
              <td width="107" height="29" valign="middle"><strong>Liên kết </strong></td>
              <td width="261" valign="middle"><label>
                <input name="url" type="text" id="url" size="30" maxlength="400" 
				value="<?php 
				echo(getValue('url','rssurl','rssurlid',$id));?>">
              </label></td>
            </tr>			
            <tr>
              <td height="29">&nbsp;</td>
              <td valign="middle">
				...
				onclick="window.open('rssnewsadmin.php?mode=30','_self')"></td>
              </tr>
			 </form> 
	 <SCRIPT language=JavaScript type=text/JavaScript>
 					...
 					function Check()
					{
						...
						{
							alert("Bạn chưa nhập tên lĩnh vực hoạt động!");
            ...
            <tr>
              <td height="29"></td>
              <td valign="middle"><a href="orgadmin.php" class="nav"></a></td>
            </tr>
            <tr>
              <td height="14"></td>
              <td></td>
