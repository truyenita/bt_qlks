...
<head>
	...
	<link rel="stylesheet" type="text/css" href="ita.css"/>
...
<body>
	<div id="wrapper">
		...
		$str1="select * from news where approval=1 and newsgroup=".$newsgroup." order by date desc,newsid desc";
		...
		{       
          		$k=$k+1;
				echo("<tr><td width='561' height='10' valign='top'>");
				echo("<a href='details.php?newsid=".$row['newsid']."&id=".$row['newsgroup']."' class='newstitlelinkspace");
				
				echo("'>".$row['title']."</a>");
				echo("<br>");
				if (strlen($row['image'])>0)
					echo("<img class='iconleft166' src='".$row['image']."' />");
				echo("<div  class='newscontent'>".$row['abstract']."</div>");
				echo("<br>");
...
////////////////////////////////////Hien thi cac tin con lai
			  
          echo("<tr><td>");
				echo("<br>");
				echo("<img src='image/nextnews.jpg' />");echo("<br>");echo("<br>");
				$i=0;
				while ($row=mysql_fetch_array($result))
				{
					...
					echo("<a alt='".$row['abstract']."' title='".$row['abstract']."' href='details.php?newsid=".$row['newsid']."&id=".$row['newsgroup']."' class='newstitle");
			...
			echo('</table>');
                    ...
                    <div class="tm-right-ct list-banner">
						<!--<ul>
							...
							<li>
								<div class="detail">
									<a href="#" class="img"><img src="page/images/banner-1.jpg" alt=""/></a>
									<h4><a href="#">Thiết kế - thi công</a></h4>
								</div>
							</li>
                ...
                <div class="block-bot tm-handbook">
							...
							<div class="tm-slick">
                                ...
                                <!--
											...
											<a href="#" class="img"><img src="images/handbook-1.jpg" alt=""/></a>
											<div class="txt-hb">
												<h3><a href="#">Tầm quan trọng của việc vệ sinh nhà xưởng </a></h3>
