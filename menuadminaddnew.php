...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="pic/notice.jpg" width="52" height="29"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Thêm mới mục menu <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
  ...
  <TR>
	...
	<form name=form action='menuadmin.php?mode=3' method=post>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td colspan="3" valign="top"><input name="menutitle" type="text" id="menutitle" size="70" maxlength="150"></td>
          </tr>		
        <tr>
          <td height="25"></td>
          ...
          <td valign="top" colspan="3"><select name="menutype" id="menutype">
            <option value="0">Mục chính, trang chủ</option>
            <option value="1">Mục con, liên kết đến tin tức của 1 newsgroup</option>
            <option value="2">Mục con, liên đến đến 1 trang nội dung cục bộ</option>
            <option value="3">Mục chính, không có liên kết</option>
            <option value="4">Mục chính, liên kết ngoài</option>
            <option value="5">Mục chính, liên kết đến 1 trang nội dung cục bộ</option> <option value="8">Mục chính, trang liên hệ</option>
           <!--
            <option value="6">Mục chính, trang văn bản pháp luật</option>
            <option value="7">Mục chính, trang hỏi đáp</option>
            <option value="8">Mục chính, trang liên hệ</option>
            <option value="9">Mục chính, trang sơ đồ website</option>
            <option value="10">Mục chính, trang danh mục các liên kết</option>
            <option value="11">Mục chính, trang lịch công tác</option>
            <option value="12">Mục chính, trang danh bạ doanh nghiệp</option>
            <option value="13">Mục con, liên kết đến trang tin tức RSS</option> 
            <!--<option value="14">Mục con, trang danh mục các liên kết</option>    
            <option value="15">Mục con, trang văn bản pháp luật</option>
             <option value="14">Mục con, trang sản phẩm</option>-->
          </select>              
          </td>
		...
		<option value="0">Không phải là menu con</option>
		...
		<?php
			...
			{
				echo("<option value='".$row0['menuid']."'>".$row0['menutitle']."</option>"); 
			}
	...
	?>
        ...
        <tr>
          ...
          <td colspan="3" valign="top"><input name="menuorder" type="text" id="menuorder" size="5" maxlength="5"></td>
          </tr>
          <!--
        <tr>
          <td height="25"></td>
          <td colspan="2" valign="top">Hiển thị menu dọc </td>
          <td colspan="3" valign="top"><input name="vermenu" type="checkbox" id="vermenu" value="1" checked="checked"></td>
          </tr>
          -->
        <tr>
          <td height="25"></td>
          <td colspan="2" valign="top">Hiển thị menu ngang </td>
          <td colspan="3" valign="top"><input name="hormenu" type="checkbox" id="hormenu" value="1"></td>
          </tr>
          <tr>
          <td height="25"></td>
          <td colspan="2" valign="top">Hiển thị HomePage </td>
          <td valign="top"><input name="homepage" type="checkbox" id="homepage" value="1"></td>
          </tr>
        <tr>
          <td height="25"></td>
          <td colspan="2" valign="top">Liên kết đến trang </td>
          <td colspan="3" valign="top"><input name="link" type="text" id="link" size="30" maxlength="300"></td>
          </tr>	
        <tr>
          <td height="25"></td>
        ...
        <tr>
          <td height="277"></td>
          <td colspan="5" valign="top"><textarea name="content" cols="70" rows="1" id="content"></textarea>
