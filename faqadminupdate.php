  ...
  <TR>
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
		<?php
			...
			$str1="select * from faq where faqid='".$id."'";
			$result=mysql_query($str1) or die(mysql_error());
			$row = mysql_fetch_array($result);
			//mysql_free_result($result);
		?>      
	<form name=form action=faqadmin.php?mode=2&id=<?php echo($row['faqid']);?> method=post>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="25"></td>
          <td colspan="2" valign="top">Người gửi </td>
          <td valign="top"><input name="questioner" type="text" id="questioner" value="<?php echo($row['questioner']);?>" size="70" maxlength="300"></td>
          </tr>		


        <tr>
          <td height="25"></td>
          <td colspan="2" valign="top">Ngày gửi </td>
        ...
        <tr>
          ...
          <td valign="top"><input name="email" type="text" id="email" value="<?php echo($row['email']);?>" size="70" maxlength="100"></td>
          </tr>	
		         <tr>
          <td height="25"></td>
          <td colspan="2" valign="top">Địa chỉ </td>
          <td valign="top"><input name="address" type="text" id="address" value="<?php echo($row['address']);?>" size="70" maxlength="100"></td>
          </tr>	
		          <tr>
          <td height="25"></td>
          <td colspan="2" valign="top">Điện thoại </td>
          <td valign="top"><input name="phone" type="text" id="phone" value="<?php echo($row['phone']);?>" size="70" maxlength="100"></td>
          </tr>	
		          <tr>
          <td height="25"></td>
          <td colspan="2" valign="top">Tiêu đề </td>
          <td valign="top"><input name="title" type="text" id="title" value="<?php echo($row['title']);?>" size="100" maxlength="100"></td>
          </tr>	
		          <tr>
          <td height="100"></td>
          <td colspan="2" valign="top">Câu hỏi </td>
          <td valign="top"><textarea name="question" cols="77" rows="5" id="question"><?php echo($row['question']);?></textarea></td>
		          </tr>	 
        <tr>
          <td height="25"></td>
          <td colspan="2" valign="top">Trả lời </td>
          <td>&nbsp;</td>
          </tr>
		  
        <tr>
          <td height="277"></td>
          <td colspan="3" valign="top"><textarea name="answer" cols="70" rows="6" id="answer"><?php echo($row['answer']);?></textarea>
