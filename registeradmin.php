    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="pic/timetable.jpg"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Cập nhật<!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
  ...
  <TR>
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr><td colspan="2">
        Tổng số : <strong><?php
		$strTS="select count(id) as sum from register  order by id desc";
						$resultTS=mysql_query($strTS) or
							die(mysql_error());
        ...
        <tr>
          ...
          <td valign="top"><TABLE class="deco" height=29 cellSpacing=0 cellPadding=0 
            ...
            <TBODY>
              <TR>
                <TD width=200 height=27 align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Họ tên </TD>
                    <TD width=100 align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Email</TD>
                      <TD width=100 align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Điện thoại</TD>
                      <TD width=200 align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Địa chỉ</TD>
                      <TD width=100 align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Công ty</TD>
                      <TD width=100 align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Tình trạng</TD>
                    <td width="100" align="center" valign="middle" background=pic/bgbt.gif class="table_title">Cập nhật</td>
                  </TR>
              ...
              <?php
					...
					if ($mode=='1')
					{
						$str1="delete from register where id=". $id;
					...
					if ($mode=='2')
					{
						...
						$status=intval(mysql_real_escape_string($_REQUEST['status']));
						
						$str1="update register set name='".$name."', date='".$date."', email='".$email;
						$str1=$str1."', address='".$address."', phone='".$phone."', company='".$company."', status='";
						$str1=$str1.$status."' where id=". $id;
						//echo($str1);
						$result=mysql_query($str1) or die(mysql_error());
					}						
					...
					$str1="select * from register order by id desc";
					...
					while ($row=mysql_fetch_array($result))
					{
						...
						echo("<TD vAlign=center height=24>&nbsp;&nbsp;".$row['name']."</TD>");
						echo("<TD vAlign=left align=middle>".$row['email']."</TD>");
						echo("<TD vAlign=left align=middle>".$row['phone']."</TD>");
						echo("<TD vAlign=left align=middle>".$row['address']."</TD>");
						echo("<TD vAlign=left align=middle>".$row['company']."</TD>");
						echo("<TD vAlign=center align=middle><center>");
						if ($row['status']==1) echo("Đã đóng tiền lệ phí");
						echo("</center></TD>");
						
						echo("<TD vAlign=center>");					
						echo("&nbsp;&nbsp;&nbsp;<a href='registerdetailadmin.php?id=".$row['id']."'>Xem</a>");
						
						echo("&nbsp;&nbsp;&nbsp;<a href='registeradmin.php?mode=1&id=".$row['id']."'>Xóa</a></center></TD></TR>");
        ...
        <tr>
          ...
          <td valign="middle">
		  <?php
		  	$selectcountsql="select count(*) as sumrecords from register order by id desc";
			ShowPageBreak($selectcountsql,"registeradmin.php");
		  ?>
		  </td>
          <td>&nbsp;</td>
        </tr>
