    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Danh sách Video<!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
  ...
  <TR>
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <!--DWLayoutTable-->
        <tr>
          <td height="458" valign="top"><p><a href="videoadd.php">+ Thêm video mới</a><br />
    </p>
      <table width="100%" class="deco" height=29 cellSpacing=0 cellPadding=0 
        ...
        <tr>
          ...
          <td width="10%" align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Đường link</td>
			<td width="19%" align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Hình minh họa</td>
          <td width="33%" align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Tên video</td>
        ...
        <?php 
		include("dbconnect.php");
		$sql_select_video = "select * from video";
		$stt=1;
        ...
        <tr>
          <td><?php echo($stt++); ?></td>
          <td>
          <?php echo($row_select_video["link"]); ?>
          </td>
		  <td>
          <img src="<?php echo($row_select_video["imagelink"]); ?>" border="0" height="45" width="60" />
          </td>
          <td><?php echo($row_select_video["ghi_chu"]); ?></td>
          <td><?php echo($row_select_video["trang_thai"]=="1"?"bật":"tắt"); ?></td>
          <td><a href="videoedit.php?editid=<?php echo($row_select_video["id"]); ?>"><img src="image/edit.gif" alt="Sửa" width="30" height="30" border="0" /></a> <a href="video.php?delid=<?php echo($row_select_video["id"]); ?>"><img src="image/delete.gif" alt="Xóa" width="30" height="30" border="0" /></a></td>
        </tr>
        <?php } ?>
      </table></td>
        </tr>
