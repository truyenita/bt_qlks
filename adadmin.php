...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
  ...
  <TR>
    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="pic/timetable.jpg">

		<!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Cập nhật quảng cáo <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td width="590">&nbsp;</td>
          <td width="161" align="right" valign="middle"><div align="right"><img src="pic/add.jpg" align="middle">&nbsp;&nbsp;<a href="adadminaddnew.php" class="nav">Thêm mới</a> </div></td>
          <td width="53">&nbsp;</td>
        </tr>
        <tr>
          <td height="29">&nbsp;</td>
          <td colspan="2" valign="top"><TABLE class="deco" height=29 cellSpacing=0 cellPadding=0 
            ...
            <TBODY>
              <TR>
                <TD width=95 height=27 vAlign=top background=pic/bgbt.gif class="table_title">Vị trí</TD>
                    <TD width=114 align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Thứ tự hiển thị </TD>
                    <TD width=374 align=middle vAlign=center 
                      background=pic/bgbt.gif class="table_title">Tên đơn vị </TD>
              ...
              <?php
					...
					//Xoa quang cao duoc chon
					if ($mode=='1')
					{
						$str1="delete from ad where adid=". $id;
						$result=mysql_query($str1) or die(mysql_error());
						//mysql_free_result($result);
						
					}
					
					//Cap nhat quang cao duoc chon
					if ($mode=='2')
					{
						$adid=intval(mysql_real_escape_string($_REQUEST['id']));
						$adname=mysql_real_escape_string($_REQUEST['adname']);
						$adimage=mysql_real_escape_string($_REQUEST['adimage']);
						$adurl=mysql_real_escape_string($_REQUEST['adurl']);
						$adorder=intval(mysql_real_escape_string($_REQUEST['adorder']));
						$adleft=intval(mysql_real_escape_string($_REQUEST['adleft']));

						
						$str1="update ad set adname='".$adname."', adimage='".$adimage."', adurl='".$adurl;
						$str1=$str1."', adorder=".$adorder.", adleft=".$adleft." where adid=". $adid;
						//echo($str1);
						$result=mysql_query($str1) or die(mysql_error());
					}						
					

					//Them 01 quang cao moi
					if ($mode=='3')
					{
						$adname=mysql_real_escape_string($_REQUEST['adname']);
						$adimage=mysql_real_escape_string($_REQUEST['adimage']);
						...
						$str1="insert into ad(adname,adimage,adurl,adorder,adleft) ";
						$str1=$str1." values ('".$adname."','".$adimage."','".$adurl."',".$adorder.",".$adleft.")";
						//echo($str1);
						$result=mysql_query($str1) or die(mysql_error());
					}					
					
					
					//Hien thi danh sach quang cao
					$str1="select * from ad order by adleft,adorder";
					...
					while ($row=mysql_fetch_array($result))
					{
						...
						echo("<TD vAlign=center align=middle height=24><center>");
						if ($row['adleft']==1)
							echo("Bên trên");
						else
							echo("Bên phải");
						echo("</center></TD>");
						echo("<TD vAlign=center align=middle><center>".$row['adorder']."</center></TD>");
						echo("<TD vAlign=left align=middle>".$row['adname']."</TD>");
						echo("<TD vAlign=center align=middle><center><a href='adadminupdate.php?mode=2&id=".$row['adid']."'>Sửa</a>");
						echo("&nbsp;&nbsp;&nbsp;<a href='adadmin.php?mode=1&id=".$row['adid']."'>Xóa</a></center></TD></TR>");
        ...
        <tr>
		  ...
		  <?php
		  	$selectcountsql="select count(*) as sumrecords from ad order by adleft,adorder";
			ShowPageBreak($selectcountsql,"adadmin.php");
		  ?>
		  </td>
          <td>&nbsp;</td>
        </tr>
