...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="pic/notice.jpg" width="52" height="29"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Thêm mới  danh mục liên kết <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
  ...
  <TR>
   ...
   <SCRIPT language=JavaScript type=text/JavaScript>
	...
	<form name=form action=listadmin.php?mode=3 method=post>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td valign="top"><input name="listtitle" type="text" id="listtitle"  size="70" maxlength="300"></td>
          </tr>		
        <tr>
          <td height="25"></td>
        ...
        <tr>
          ...
          <td valign="top"><input name="listorder" type="text" id="listorder" size="5" maxlength="5"></td>
          </tr>
	...
	<script type="text/javascript">
        ...
        <tr>
          <td height="277"></td>
          <td colspan="3" valign="top"><textarea name="listcontent" cols="70" rows="6" id="listcontent"></textarea>
		  <script type="text/javascript"> 
			//<![CDATA[
