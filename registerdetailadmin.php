    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="pic/notice.jpg" width="52" height="29"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Xem thông tin hội viên <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
		  ...
		  <?php
				...
				$str1="select * from register where id=".$newsid;
				$result=mysql_query($str1) or
					die(mysql_error());
				$row=mysql_fetch_array($result);
				echo("<div  class='newstitleNOLINK");
				//echo(template());
				echo("'>Họ và tên :&nbsp;&nbsp;".$row['name']."</div>"); 
			
				echo("<div  class='newstitleNOLINK'>Điện thoại : &nbsp;&nbsp;".$row['phone']."</div>");
				
				
				echo("<div  class='newstitleNOLINK'>Email : &nbsp;&nbsp;".$row['email']."</div>");
				echo("<div  class='newstitleNOLINK'>Địa chỉ : &nbsp;&nbsp;".$row['address']."</div>");
				echo("<div  class='newstitleNOLINK'>Công ty : &nbsp;&nbsp;".$row['company']."</div>");
				echo("<br>");
        ...
        <tr>
		  ...
		  <?php 
		  	...
		  	{
		  ?>
		  <form name="form" action="updatedb.php?action=16&id=<?php echo($row['id']);?>" method="post">
		  <?php 
		  ...
		  ?>
		  <input type="button" name="button" value="Quay lại trang trước" onClick="javascript:history.back(-1)">
		  </form>
