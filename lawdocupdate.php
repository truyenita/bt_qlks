...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="pic/notice.jpg" width="52" height="29"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Cập nhật  văn bản <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
  ...
  <TR>
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
			...
			$str1="select * from lawdoc where docid=".$id;
			$result=mysql_query($str1) or die(mysql_error());
			$row = mysql_fetch_array($result);

			//mysql_free_result($result);
		?> 
	<form name=form action='lawdocadmin.php?mode=2&id=<?php echo($row['docid']);?>' method=post>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td valign="top"><select name="loaivb" id="loaivb">
					<?php
					include("dbconnect.php");
					...
					{
						echo("<option ");
						if ($row['loaivb']==$row0['id']) echo("selected='selected'"); 
        ...
        <tr>
          ...
          <td valign="top"><input name="docno" type="text" id="docno" size="50" maxlength="50" value="<?php echo($row['docno']);?>"></td>
          </tr>		
        <tr>
          <td height="25"></td>
          <td valign="top">Ngày ban hành </td>
          <td valign="top"><input name="date" type="text" id="date"  value="<?php echo($row['date']);?>" size="15" maxlength="15"><a href="javascript:void(displayDatePicker('date', false, 'ymd', '-'))"><img src="image/date.jpg" width="20" height="16" border="0"></a></td>
          </tr>
        <tr>
          <td height="25"></td>
          <td valign="top">Văn bản mới </td>
          <td valign="top"><label>
            <input name="new" type="checkbox" id="new" value="1" <?php if ($row['new']==1) echo("checked='checked'");?>>
          </label></td>
        </tr>
        <tr>
          <td height="26"></td>
          ...
          <td valign="top"><select name="type" id="type">
					...
					{
						echo("<option ");
						if ($row['type']==$row0['typeid']) echo("selected='selected'"); 
        ...
        <tr>
          ...
          <td valign="top"><select name="field" id="field">
					<?php
					include("dbconnect.php");
					...
					{
						echo("<option ");
						if ($row['field']==$row0['fieldid']) echo("selected='selected'"); 
        ...
        <tr>
          ...
          <td valign="top"><select name="level" id="level">
					...
					{
						echo("<option ");
						if ($row['level']==$row0['levelid']) echo("selected='selected'"); 
        ...
        <tr>
          ...
          <td valign="top"><input name="deptname" type="text" id="deptname" size="30" maxlength="30"  value="<?php echo($row['deptname']);?>"></td>
          </tr>	
        <tr>
          <td height="25"></td>
          <td valign="top">Người ký văn bản </td>
          <td valign="top"><input name="sign" type="text" id="sign" size="30" maxlength="30"  value="<?php echo($row['sign']);?>"></td>
          </tr>	
	<script type="text/javascript" src="ckfinder/ckfinder.js"></script>
	<script type="text/javascript">
        ...
        <tr>
          ...
          <td valign="top"><input name="file" type="text" id="file" size="30" maxlength="30"  value="<?php echo($row['file']);?>">
        ...
        <tr>
          ...
          <td rowspan="2" valign="top"><textarea name="abstract" cols="70" rows="5" id="abstract"><?php echo($row['abstract']);?></textarea>		  </td>
          </tr>
        <tr>
          <td height="83"></td>
          <td>&nbsp;</td>
