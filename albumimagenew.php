...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" -->aa<!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Thêm tiêu đề Album <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
  ...
  <TR>
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
      <form name=form action=albumimagelist.php?mode=3 method=post>
	 ...
	 <SCRIPT language=JavaScript type=text/JavaScript>
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td valign="top"><input name="tenalbum" type="text" id="tenalbum" size="70" maxlength="300"></td>
          </tr>		
<tr>
          <td height="25"></td>
          ...
          <td>Trạng thái:</td>
          <td><label>
            <input type="checkbox" name="trang_thai" id="trang_thai" checked="checked"/>
          </label></td>
        </tr>
	<script type="text/javascript" src="ckfinder/ckfinder.js"></script>
