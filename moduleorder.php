...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" --><img src="pic/notice.jpg" width="52" height="29"><!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Quy định thứ tự hiển thị  các module <!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
  ...
  <TR>
	...
	<form name=form action="updatedb.php?action=2"  method=post>
	  <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="30"></td>
          <td><div align="center"><strong>Tên module</strong></div></td>
          <td><div align="center"><strong>Vị trí hiển thị</strong></div></td>
          <td valign="middle"><div align="center"><strong>Thứ tự hiển thị</strong></div></td>
        <td>&nbsp;</td>
        </tr>
<?php
	$str0="select * from options where ismodule=1 order by leftmodule,moduleorder";
...
?>
        ...
        <tr>
          <td height="25">&nbsp;</td>
          <td valign="middle"><?php echo($row0['value2']);?></td>
          <td valign="middle">
		    <div align="center">
		      <?php 
		  	if($row0['leftmodule']==1) 
				echo("Bên trái");
			else
				echo("Bên phải");
		  ?>		  
          ...
          <td valign="middle">
            <div align="center">
              <select name="<?php echo($row0['name']);?>">
                <option value="1" <?php if ($row0['moduleorder']==1) echo('selected="selected"');?>>1</option>
                <option value="2" <?php if ($row0['moduleorder']==2) echo('selected="selected"');?>>2</option>
                <option value="3" <?php if ($row0['moduleorder']==3) echo('selected="selected"');?>>3</option>
                <option value="4" <?php if ($row0['moduleorder']==4) echo('selected="selected"');?>>4</option>
                <option value="5" <?php if ($row0['moduleorder']==5) echo('selected="selected"');?>>5</option>
                <option value="6" <?php if ($row0['moduleorder']==6) echo('selected="selected"');?>>6</option>
                <option value="7" <?php if ($row0['moduleorder']==7) echo('selected="selected"');?>>7</option>
                <option value="8" <?php if ($row0['moduleorder']==8) echo('selected="selected"');?>>8</option>
                <option value="9" <?php if ($row0['moduleorder']==9) echo('selected="selected"');?>>9</option>
                <option value="10" <?php if ($row0['moduleorder']==10) echo('selected="selected"');?>>10</option>
                <option value="11" <?php if ($row0['moduleorder']==11) echo('selected="selected"');?>>11</option>
                <option value="12" <?php if ($row0['moduleorder']==12) echo('selected="selected"');?>>12</option>
                <option value="13" <?php if ($row0['moduleorder']==13) echo('selected="selected"');?>>13</option>
                <option value="14" <?php if ($row0['moduleorder']==14) echo('selected="selected"');?>>14</option>
                <option value="15" <?php if ($row0['moduleorder']==15) echo('selected="selected"');?>>15</option>
                <option value="16" <?php if ($row0['moduleorder']==16) echo('selected="selected"');?>>16</option>
                <option value="17" <?php if ($row0['moduleorder']==17) echo('selected="selected"');?>>17</option>
                <option value="18" <?php if ($row0['moduleorder']==18) echo('selected="selected"');?>>18</option>
                <option value="19" <?php if ($row0['moduleorder']==19) echo('selected="selected"');?>>19</option>
                <option value="20" <?php if ($row0['moduleorder']==20) echo('selected="selected"');?>>20</option>
              </select>
            </div></td>
        <td>&nbsp;</td>
        </tr> 
