    ...
    <TD valign="top"><table width="295" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="52" height="29"><!-- InstanceBeginEditable name="EditRegion1" -->aa<!-- InstanceEndEditable --></td>
            <td width="243" valign="top" class="lefttitle"><!-- InstanceBeginEditable name="EditRegion2" -->Thêm ảnh<!-- InstanceEndEditable --></td>
          </tr>
      <tr>
        <td height="3" colspan="2" valign="top"><table background="pic/hline.jpg" width="295" border="0" cellpadding="0" cellspacing="0">
          <!--DWLayoutTable-->
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <form id="form" name="form" method="post" action="hinhanh.php" enctype="multipart/form-data">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="20%">Hình:</td>
          <td width="80%">
            <input name="duongdananh" type="text" id="duongdananh">
            <input name="submit" type="button" value="Chọn Image" onClick="BrowseServer();">
          </td>
        </tr>
        <tr>
          <td>Ghi chú:</td>
		...
		<tr>
          ...
          <td><label>
            <select name="idalbum1" id="idalbum1" >
        	  <?php
              //include("../dbconnect.php");
              $sql_select_cs = "select * from album1";
              $result_select_cs = mysql_query($sql_select_cs) or die(mysql_error());
              while($row_select_cs = mysql_fetch_array($result_select_cs))
              {
              ?>
              <option value="<?php echo($row_select_cs["id"]); ?>" selected><?php echo($row_select_cs["tenalbum"]); ?></option>
              <?php
              }
              ?>
            </select>
          ...
          <td>Trạng thái:</td>
          <td><label>
            <input type="checkbox" name="trangthai" id="trangthai" checked="checked"/>
          </label></td>
        </tr>
        <tr>
          <td>
	...
	<script type="text/javascript">
		...
		function SetFileField( fileUrl )
		{
          ...
          <td><label>
            <input type="submit" name="addha" id="addha" value="Lưu" />
            <input type="reset" name="reset" id="reset" value="Xóa" />
            <input type="hidden" name="addha" id="addha" />
          </label></td>
        </tr>
      </table></form></td>
        </tr>
