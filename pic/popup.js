...
if(isresize){
rdiv.innerHTML='<img src="../ila_files/resize.gif" width="7" height="7">';
...
titlebar.innerHTML='<span id="'+cid+'_btt" style="position:absolute; width:48px; height:16px; left:'+(tw-48)+'px; top:2px;"><img src="../ila_files/images/map/min.gif" width="16" height="16" id="'+cid+'_min"><img src="../ila_files/images/map/max.gif" width="16" height="16"  id="'+cid+'_max"><img src="../ila_files/images/map/close.gif" width="16" height="16" id="'+cid+'_cls"></span>';
...
content.style.borderStyle="window-inset";
