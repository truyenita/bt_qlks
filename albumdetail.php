                        ...
                        <div id="ninja-slider">
                            <div class="slider-inner">
                                <ul>
									...
									$str1="select * from album2 where trangthai=1 and idalbum1='".$_REQUEST["gallary"]."' order by id desc";
								$result_pic=mysql_query($str1) or die(mysql_error());
                                while($row= mysql_fetch_array($result_pic))
                                {
                                            
                                            echo '<li>';
                                            echo '<a class="ns-img" href="'.$row["duongdananh"].'"></a>';
                            ...
                            <div class="gallery">
                                 ...
                                 while($row= mysql_fetch_array($result))
                                {
                                        ...
                                        echo '<img style="width: 120px; height: 80px;" src="'.$row["duongdananh"].'" onclick="lightbox('.$stt++.')" />';
