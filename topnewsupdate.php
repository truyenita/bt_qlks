...
<?php
	if (updateNotice($_SESSION['user'])==0)  
		header('Location:portal/login.php?id=2');
?>
	<!-- InstanceEndEditable -->
<style type="text/css">
...
<TABLE bgcolor="#FFFFFF" cellSpacing=0 cellPadding=0 width=962 height="300" align=center border=0><!--DWLayoutTable-->
  ...
  <TR>
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
		...
		?>     
	<form name=form action='updatedb.php?action=6' method=post>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="316"></td>
          <td colspan="2" valign="top"><textarea cols="80" id="topnews" name="topnews" rows="10"> <?php echo($row['value3']);mysql_free_result($result);?></textarea> 
			...
			//<![CDATA[
				...
				var editor = CKEDITOR.replace( 'topnews' );
