  ...
  <TR>
    ...
    <TD colspan="2" valign="top"><!-- InstanceBeginEditable name="EditRegion3" -->
		<?php
			...
			$str1="select * from weblist where id='".$id."'";
			$result=mysql_query($str1) or die(mysql_error());
			$row = mysql_fetch_array($result);
			//mysql_free_result($result);
		?>      
	<form name=form action=weblistadmin.php?mode=2&id=<?php echo($row['id']);?> method=post>
	 ...
	 <SCRIPT language=JavaScript type=text/JavaScript>
 					...
 					function Check()
					{
						...
						{
							alert("Bạn chưa nhập tên liên kết");
...
<tr>
        ...
        <tr>
          <td height="25"></td>
          <td valign="top">Liên kết</td>
          <td valign="top"><input name="link" type="text" id="link" value="<?php echo($row['link']);?>" size="70" maxlength="300"></td>
          </tr>		
        <tr>
          <td height="25"></td>
          <td>&nbsp;</td>
